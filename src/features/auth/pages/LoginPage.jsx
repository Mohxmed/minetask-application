...
function LoginPage() {
  return (
    <div className="min-h-screen w-full flex flex-col sm:flex-row dark:bg-slate-950 max-sm:bg-primary max-sm:pattern max-sm:items-center">
      <div className="bg-primary/30 pattern flex items-center justify-center w-full lg:w-3/5 sm:w-1/2 p-6 max-sm:mt-6 sm:min-h-screen">
